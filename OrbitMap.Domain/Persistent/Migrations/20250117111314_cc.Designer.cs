...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OrbitMap.Domain.Entities.BusinessService", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("cad0086a-c64a-4e63-b6e7-e98638a8b8dc"),
                            BusinessServiceType = "FIRST_RESANDHOTEL",
                            Price = 299000m
                        },
                        new
                        {
                            Id = new Guid("d0163ee2-a305-4a1d-aaed-345cc479c76c"),
            ...
            modelBuilder.Entity("OrbitMap.Domain.Entities.Friendship", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 1, 17, 11, 13, 14, 479, DateTimeKind.Utc).AddTicks(2320),
            ...
            modelBuilder.Entity("OrbitMap.Domain.Entities.MessageTest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("MessageTest");

                    b.HasData(
                        new
                        {
                            Id = new Guid("509f9db4-98d8-4807-8f79-2ad24cf271e9"),
                            MessageDocument = "{\"SenderUsername\":\"hoang\",\"RecipientUsername\":\"khoa\",\"Content\":\"kkk\",\"DateRead\":\"2025-01-17T18:13:14.482746+07:00\",\"StoryId\":\"3300569b-0d72-4882-a1d2-db3a9bdf67d2\"}"
                        });
                });
            ...
            modelBuilder.Entity("OrbitMap.Domain.Entities.News", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 1, 17, 11, 13, 14, 482, DateTimeKind.Utc).AddTicks(8790),
                            ExpirationDate = new DateTime(2025, 2, 17, 11, 13, 14, 482, DateTimeKind.Utc).AddTicks(8830),
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 1, 17, 11, 13, 14, 482, DateTimeKind.Utc).AddTicks(8830),
                            ExpirationDate = new DateTime(2025, 2, 17, 11, 13, 14, 482, DateTimeKind.Utc).AddTicks(8830),
                            ImageUrls = new List<string> { "https://res.cloudinary.com/dl1sfqrek/image/upload/v1736783634/4fa1560a-245a-414c-a2ba-ed6ab02368a2.png" },
            ...
            modelBuilder.Entity("OrbitMap.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 1, 17, 11, 13, 14, 483, DateTimeKind.Utc).AddTicks(6250),
                            DisplayName = "admin",
            ...
            modelBuilder.Entity("OrbitMap.Domain.Entities.Member", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AvatarUrl = "https://res.cloudinary.com/dl1sfqrek/image/upload/v1736499707/ad62b614-4cb7-4e59-af56-ebd47319cf6b.jpg",
                            CreatedDate = new DateTime(2025, 1, 17, 11, 13, 14, 480, DateTimeKind.Utc).AddTicks(8640),
                            ...
                            IsPremium = true,
                            LastActive = new DateTime(2025, 1, 17, 11, 13, 14, 480, DateTimeKind.Utc).AddTicks(8300)
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 1, 17, 11, 13, 14, 480, DateTimeKind.Utc).AddTicks(8760),
                            ...
                            Birthday = new DateOnly(1999, 1, 1),
                            IsPremium = true,
                            LastActive = new DateTime(2025, 1, 17, 11, 13, 14, 480, DateTimeKind.Utc).AddTicks(8740)
                        },
                        new
                        {
                            Id = new Guid("68c029f3-b49f-41da-864c-40299f71a956"),
                            AvatarUrl = "https://res.cloudinary.com/dl1sfqrek/image/upload/v1736250368/fc72a64e-91fd-495b-bf19-b0f9ae97f1cc.png",
                            CreatedDate = new DateTime(2025, 1, 17, 11, 13, 14, 480, DateTimeKind.Utc).AddTicks(8770),
                            DisplayName = "quan",
                            ...
                            Birthday = new DateOnly(1999, 1, 1),
                            IsPremium = true,
                            LastActive = new DateTime(2025, 1, 17, 11, 13, 14, 480, DateTimeKind.Utc).AddTicks(8770)
                        });
                });
