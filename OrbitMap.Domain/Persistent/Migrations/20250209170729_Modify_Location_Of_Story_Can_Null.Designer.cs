...
namespace OrbitMap.Domain.Persistent.Migrations
{
    ...
    [Migration("20250209170729_Modify_Location_Of_Story_Can_Null")]
    partial class Modify_Location_Of_Story_Can_Null
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OrbitMap.Domain.Entities.BusinessService", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("70a719f0-a91e-4be2-ab97-8c44e4cc1d5e"),
                            BusinessServiceType = "FIRST_RESANDHOTEL",
                            Price = 299000
                        },
                        new
                        {
                            Id = new Guid("0e0d10e0-3424-4174-ad71-a53106f3c604"),
            ...
            modelBuilder.Entity("OrbitMap.Domain.Entities.Friendship", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 2, 9, 17, 7, 29, 560, DateTimeKind.Utc).AddTicks(1650),
            ...
            modelBuilder.Entity("OrbitMap.Domain.Entities.News", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 2, 9, 17, 7, 29, 560, DateTimeKind.Utc).AddTicks(7590),
                            ExpirationDate = new DateTime(2025, 3, 9, 17, 7, 29, 560, DateTimeKind.Utc).AddTicks(7590),
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 2, 9, 17, 7, 29, 560, DateTimeKind.Utc).AddTicks(7600),
                            ExpirationDate = new DateTime(2025, 3, 9, 17, 7, 29, 560, DateTimeKind.Utc).AddTicks(7600),
                            ImageUrls = new List<string> { "https://res.cloudinary.com/dl1sfqrek/image/upload/v1736783634/4fa1560a-245a-414c-a2ba-ed6ab02368a2.png" },
            ...
            modelBuilder.Entity("OrbitMap.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 2, 9, 17, 7, 29, 561, DateTimeKind.Utc).AddTicks(4090),
                            DisplayName = "admin",
            ...
            modelBuilder.Entity("OrbitMap.Domain.Entities.Member", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AvatarUrl = "https://res.cloudinary.com/dl1sfqrek/image/upload/v1736499707/ad62b614-4cb7-4e59-af56-ebd47319cf6b.jpg",
                            CreatedDate = new DateTime(2025, 2, 9, 17, 7, 29, 560, DateTimeKind.Utc).AddTicks(4310),
                            ...
                            IsPremium = true,
                            LastActive = new DateTime(2025, 2, 9, 17, 7, 29, 560, DateTimeKind.Utc).AddTicks(4140)
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 2, 9, 17, 7, 29, 560, DateTimeKind.Utc).AddTicks(4450),
                            ...
                            Birthday = new DateOnly(1999, 1, 1),
                            IsPremium = true,
                            LastActive = new DateTime(2025, 2, 9, 17, 7, 29, 560, DateTimeKind.Utc).AddTicks(4440)
                        },
                        new
                        {
                            Id = new Guid("68c029f3-b49f-41da-864c-40299f71a956"),
                            AvatarUrl = "https://res.cloudinary.com/dl1sfqrek/image/upload/v1736250368/fc72a64e-91fd-495b-bf19-b0f9ae97f1cc.png",
                            CreatedDate = new DateTime(2025, 2, 9, 17, 7, 29, 560, DateTimeKind.Utc).AddTicks(4470),
                            DisplayName = "quan",
                            ...
                            Birthday = new DateOnly(1999, 1, 1),
                            IsPremium = true,
                            LastActive = new DateTime(2025, 2, 9, 17, 7, 29, 560, DateTimeKind.Utc).AddTicks(4460)
                        });
                });
