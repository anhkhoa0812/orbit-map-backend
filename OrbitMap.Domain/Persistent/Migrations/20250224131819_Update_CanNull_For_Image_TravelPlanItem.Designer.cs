...
namespace OrbitMap.Domain.Persistent.Migrations
{
    ...
    [Migration("20250224131819_Update_CanNull_For_Image_TravelPlanItem")]
    partial class Update_CanNull_For_Image_TravelPlanItem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OrbitMap.Domain.Entities.Friendship", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 2, 24, 13, 18, 18, 996, DateTimeKind.Utc).AddTicks(5800),
            ...
            modelBuilder.Entity("OrbitMap.Domain.Entities.News", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 2, 24, 13, 18, 18, 997, DateTimeKind.Utc).AddTicks(2200),
                            ExpirationDate = new DateTime(2025, 3, 24, 13, 18, 18, 997, DateTimeKind.Utc).AddTicks(2210),
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 2, 24, 13, 18, 18, 997, DateTimeKind.Utc).AddTicks(2220),
                            ExpirationDate = new DateTime(2025, 3, 24, 13, 18, 18, 997, DateTimeKind.Utc).AddTicks(2220),
                            ImageUrls = new List<string> { "https://res.cloudinary.com/dl1sfqrek/image/upload/v1736783634/4fa1560a-245a-414c-a2ba-ed6ab02368a2.png" },
            ...
            modelBuilder.Entity("OrbitMap.Domain.Entities.TravelPlan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("OrbitMap.Domain.Entities.TravelPlanDay", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("TravelPlanDay");
                });

            modelBuilder.Entity("OrbitMap.Domain.Entities.TravelPlanItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("TravelPlanDayId")
                        .HasColumnType("uuid");

                    b.HasKey("Id");

                    b.HasIndex("TravelPlanDayId");

                    b.ToTable("TravelPlanItem");
                });
            ...
            modelBuilder.Entity("OrbitMap.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 2, 24, 13, 18, 18, 998, DateTimeKind.Utc).AddTicks(1440),
                            DisplayName = "admin",
            ...
            modelBuilder.Entity("OrbitMap.Domain.Entities.Business", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("edda5af1-27b1-466b-9037-ab4a91b269d8"),
                            AvatarUrl = "https://s3-hcm5-r1.longvan.net/19429498-orbitmap/10000010_2.jpg",
                            CreatedDate = new DateTime(2025, 2, 24, 13, 18, 18, 994, DateTimeKind.Utc).AddTicks(7010),
                            DisplayName = "PIZZA 4P'S",
                            PasswordHash = "8qrwKJFXESb38JnzyNSpTvSX8iAD3ukNxnhROHUHtHw=",
                            PhoneNumber = "0435377485",
                            RoleId = new Guid("3fd223f6-3edd-4c87-888a-35defcff39e8"),
                            Username = "pizza4p",
                            Address = "8/15 Lê Thánh Tôn, Bến Nghé, Quận 1, Thành phố Hồ Chí Minh",
                            BusinessServiceId = new Guid("50cd0e88-e256-424b-b694-bdfe52d40bab"),
                            BusinessType = "Restaurant",
                            Latitude = 10.8018374,
                            LocationId = "vnSG",
                            Longitude = 106.74586499999999
                        });
                });
            ...
            modelBuilder.Entity("OrbitMap.Domain.Entities.Member", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AvatarUrl = "https://res.cloudinary.com/dl1sfqrek/image/upload/v1736499707/ad62b614-4cb7-4e59-af56-ebd47319cf6b.jpg",
                            CreatedDate = new DateTime(2025, 2, 24, 13, 18, 18, 996, DateTimeKind.Utc).AddTicks(9040),
                            ...
                            IsPremium = true,
                            LastActive = new DateTime(2025, 2, 24, 13, 18, 18, 996, DateTimeKind.Utc).AddTicks(8930)
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 2, 24, 13, 18, 18, 996, DateTimeKind.Utc).AddTicks(9160),
                            ...
                            Birthday = new DateOnly(1999, 1, 1),
                            IsPremium = true,
                            LastActive = new DateTime(2025, 2, 24, 13, 18, 18, 996, DateTimeKind.Utc).AddTicks(9150)
                        },
                        new
                        {
                            Id = new Guid("68c029f3-b49f-41da-864c-40299f71a956"),
                            AvatarUrl = "https://res.cloudinary.com/dl1sfqrek/image/upload/v1736250368/fc72a64e-91fd-495b-bf19-b0f9ae97f1cc.png",
                            CreatedDate = new DateTime(2025, 2, 24, 13, 18, 18, 996, DateTimeKind.Utc).AddTicks(9190),
                            DisplayName = "quan",
                            ...
                            Birthday = new DateOnly(1999, 1, 1),
                            IsPremium = true,
                            LastActive = new DateTime(2025, 2, 24, 13, 18, 18, 996, DateTimeKind.Utc).AddTicks(9170)
                        });
                });
            ...
            modelBuilder.Entity("OrbitMap.Domain.Entities.TravelPlanDay", b =>
                {
                    b.HasOne("OrbitMap.Domain.Entities.TravelPlan", "TravelPlan")
                        .WithMany("TravelPlanDays")
            ...
            modelBuilder.Entity("OrbitMap.Domain.Entities.TravelPlanItem", b =>
                {
                    b.HasOne("OrbitMap.Domain.Entities.TravelPlanDay", "TravelPlanDay")
                        .WithMany("TravelPlanItems")
                        .HasForeignKey("TravelPlanDayId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("TravelPlanDay");
                });
            ...
            modelBuilder.Entity("OrbitMap.Domain.Entities.TravelPlan", b =>
                {
                    b.Navigation("TravelPlanDays");
                });

            modelBuilder.Entity("OrbitMap.Domain.Entities.TravelPlanDay", b =>
                {
                    b.Navigation("TravelPlanItems");
                });
