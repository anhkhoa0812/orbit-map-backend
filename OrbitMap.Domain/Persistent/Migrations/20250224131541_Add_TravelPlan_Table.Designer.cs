...
namespace OrbitMap.Domain.Persistent.Migrations
{
    ...
    [Migration("20250224131541_Add_TravelPlan_Table")]
    partial class Add_TravelPlan_Table
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("OrbitMap.Domain.Entities.Friendship", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 2, 24, 13, 15, 41, 216, DateTimeKind.Utc).AddTicks(1910),
            ...
            modelBuilder.Entity("OrbitMap.Domain.Entities.News", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 2, 24, 13, 15, 41, 216, DateTimeKind.Utc).AddTicks(7450),
                            ExpirationDate = new DateTime(2025, 3, 24, 13, 15, 41, 216, DateTimeKind.Utc).AddTicks(7460),
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 2, 24, 13, 15, 41, 216, DateTimeKind.Utc).AddTicks(7470),
                            ExpirationDate = new DateTime(2025, 3, 24, 13, 15, 41, 216, DateTimeKind.Utc).AddTicks(7470),
                            ImageUrls = new List<string> { "https://res.cloudinary.com/dl1sfqrek/image/upload/v1736783634/4fa1560a-245a-414c-a2ba-ed6ab02368a2.png" },
            ...
            modelBuilder.Entity("OrbitMap.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 2, 24, 13, 15, 41, 217, DateTimeKind.Utc).AddTicks(7130),
                            DisplayName = "admin",
            ...
            modelBuilder.Entity("OrbitMap.Domain.Entities.Business", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 2, 24, 13, 15, 41, 214, DateTimeKind.Utc).AddTicks(6740),
            ...
            modelBuilder.Entity("OrbitMap.Domain.Entities.Member", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AvatarUrl = "https://res.cloudinary.com/dl1sfqrek/image/upload/v1736499707/ad62b614-4cb7-4e59-af56-ebd47319cf6b.jpg",
                            CreatedDate = new DateTime(2025, 2, 24, 13, 15, 41, 216, DateTimeKind.Utc).AddTicks(4230),
                            ...
                            IsPremium = true,
                            LastActive = new DateTime(2025, 2, 24, 13, 15, 41, 216, DateTimeKind.Utc).AddTicks(4190)
                        },
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2025, 2, 24, 13, 15, 41, 216, DateTimeKind.Utc).AddTicks(4390),
                            ...
                            Birthday = new DateOnly(1999, 1, 1),
                            IsPremium = true,
                            LastActive = new DateTime(2025, 2, 24, 13, 15, 41, 216, DateTimeKind.Utc).AddTicks(4340)
                        },
                        new
                        {
                            Id = new Guid("68c029f3-b49f-41da-864c-40299f71a956"),
                            AvatarUrl = "https://res.cloudinary.com/dl1sfqrek/image/upload/v1736250368/fc72a64e-91fd-495b-bf19-b0f9ae97f1cc.png",
                            CreatedDate = new DateTime(2025, 2, 24, 13, 15, 41, 216, DateTimeKind.Utc).AddTicks(4400),
                            DisplayName = "quan",
                            ...
                            Birthday = new DateOnly(1999, 1, 1),
                            IsPremium = true,
                            LastActive = new DateTime(2025, 2, 24, 13, 15, 41, 216, DateTimeKind.Utc).AddTicks(4400)
                        });
                });
